...
<div class="container">
	<div class="left-section">
		<div class="inner-content">
			<h1 class="heading">HATA</h1>
			<p class="subheading">Girdiğiniz kimlik numarası ve HES kodu eşleşmesi bulunamadı. Lütfen girdiğiniz değerleri kontrol ederek tekrar deneyiniz.</p>
		</div>
	</div>
